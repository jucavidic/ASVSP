...
@dag(
    dag_id="f1_rpm_correlation",
    description="Ferrari RPM and speed correlation with track position in Budapest 2025",
    start_date=datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
)
def f1_rpm_correlation():
